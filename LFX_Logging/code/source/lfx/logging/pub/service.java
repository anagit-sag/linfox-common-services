...

{
	...
	// Logger context for all LfxLogger logging
	...
	private static void configure() {
		...
		try {
		  ...
		  com.wm.util.JournalLogger.log(
	              ...
	              com.wm.util.JournalLogger.FAC_FLOW_SVC,
	              com.wm.util.JournalLogger.INFO,
				  "LfxLog: Using slf4j-api v" + slf4jVersion + " from " + slf4jPath);		  
		  
				  com.wm.util.JournalLogger.log(
						  com.wm.util.JournalLogger.INFO,
			              com.wm.util.JournalLogger.FAC_FLOW_SVC,
			              com.wm.util.JournalLogger.INFO,
						  "LfxLog: Using Logback from " + logbackPath);
		  ...
		  String configFileName = System.getProperty("watt.lfx.log.config");
	
		  // If none exists, then let's create a default one
		  if (configFileName == null || configFileName.isEmpty()) {
			  configFileName = "packages/LFX_Logging/config/lfxlog_default.xml";
			  System.getProperties().put("watt.lfx.log.config", configFileName);
			  com.wm.util.JournalLogger.log(
					  com.wm.util.JournalLogger.INFO,
		              com.wm.util.JournalLogger.FAC_FLOW_SVC,
		              com.wm.util.JournalLogger.INFO,
					  "LfxLog: Using default logger configuration");
		  }  
		  ...
		  if (!configFile.exists()) {
			  ...
			  com.wm.util.JournalLogger.log(
		              ...
		              com.wm.util.JournalLogger.FAC_FLOW_SVC,
		              com.wm.util.JournalLogger.INFO,
					  "LfxLog: Can't find " + configFileName + ", using default");
			  configFileName = "packages/LFX_Logging/config/lfxlog_default.xml";
		  ...
		  com.wm.util.JournalLogger.log(
	              ...
	              com.wm.util.JournalLogger.FAC_FLOW_SVC,
	              com.wm.util.JournalLogger.INFO,
	              "LfxLog: Loading logger configuration: "+configFileName + ":\n" + context.getLoggerList().toString());
	...
	public static void log(String loggerName, String message, Level level) {
		...
		try {
			...
			com.wm.util.JournalLogger.log(4, 90, 1, "LfxLog: Could not log message: " + e.toString());
		}
	}
	...
	public static void logFromJava(String logger, String message, ch.qos.logback.classic.Level level) {
		...
		NSName logService = NSName.create("lfx.logging.pub.service:log");
